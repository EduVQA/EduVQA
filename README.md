...
All models are trained on EduAVQABench and evaluated on two benchmarks.
...
|--------------|------------------------|------------------------|
| **EduAVQABench (Ours)** | **0.5558 / 0.6346** | **0.5745 / 0.5941** |
...
| Train Dataset | Perceptual (SRCC/PLCC) | Alignment (SRCC/PLCC) |
|--------------|------------------------|------------------------|
| **EduAVQABench (Ours)** | **0.3950 / 0.3866** | 0.5580 / 0.5343 |
...
| Train Dataset | Perceptual (SRCC/PLCC) | Alignment (SRCC/PLCC) |
|--------------|------------------------|------------------------|
| **EduAVQABench (Ours)** | **0.3374 / 0.3405** | 0.4358 / 0.4456 |
...
| Train Dataset | Perceptual (SRCC/PLCC) | Alignment (SRCC/PLCC) |
|--------------|------------------------|------------------------|
| **EduAVQABench (Ours)** | **0.5902** / 0.5704 | 0.5428 / 0.5627 |
...
- **Xinlong Bu**: [xlbu@m.scnu.edu.cn](mailto:xlbu@m.scnu.edu.cn)
